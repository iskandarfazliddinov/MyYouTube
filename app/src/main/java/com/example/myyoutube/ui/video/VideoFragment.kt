package com.example.myyoutube.ui.video
...
import com.example.myyoutube.databinding.FragmentVideoBinding
...
class VideoFragment : Fragment() {
    ...
    override fun onCreateOptionsMenu(menu: Menu, inflater: MenuInflater) {
        ...
        searchView.queryHint = resources.getString(R.string.serach_video)
        searchView.setOnQueryTextListener(object :SearchView.OnQueryTextListener{
            override fun onQueryTextSubmit(query: String?): Boolean {
                if(query!!.isNotEmpty()){
                    videoViewModel?.querySearch = query
                    adapter.clearAll()
